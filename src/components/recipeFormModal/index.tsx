        ...
        <DialogTitle>Nova Receita</DialogTitle>
                ...
                <form className="flex flex-col gap-4 w-full">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <input className={inputStyles} type="text" id="image" placeholder="/placeholder.svg?height=400&width=600" />
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-2">
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <textarea className={inputStyles} id="servings" defaultValue="1" />
                        </div>
                    </div>
